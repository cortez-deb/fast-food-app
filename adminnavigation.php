  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav navbar-nav">
                <li class="active col"> <a href="adminRouter.php?page=admin_pending_products"  class="btn btn-hover">PENDING PRODUCTS</a></li>
                <li class="active col"><a href="adminRouter.php?page=admin_complete_deliverie"  class="btn btn-hover">COMPLETE DELIVERIES</a></li>

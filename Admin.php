...
---->
    ...
    <div class="navbar-fixed">
      <nav class="navbar-color">
        <div class="nav-wrapper">
          <ul class="left">
            <li>
              <h1 class="logo-wrapper"><a href="#" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1>
            </li>
          </ul>
        </div>
      </nav>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
          <li class="user-details cyan darken-2">
            <div class="row">
              ...
              <div class="col col s8 m8 l8">
                <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo "Mark Owino"; ?> <i class="mdi-navigation-arrow-drop-down right"></i></a>
                <p class="user-roal"><?php echo "Admnistrator"; ?></p>
              </div>
            </div>
          </li>
          <li class="bold active"><a href="router.php?page=index" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
          </li>
          <li class="no-padding">
                ...
                <div class="collapsible-body">
                  <ul>
                    <li><a href="all-orders.php">All Orders</a>
                      <!-- ============================================
										sql code to select distinct status from orders 
										========================================== -->
                    </li>
                  </ul>
                </div>
              ...
              <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tickets</a>
                <div class="collapsible-body">
                  <ul>
                    ...
                    <!-- ============================================
										sql code to select distinct status from tickets
										========================================== -->
              ...
              <div>
                <table id="data-table-admin" class="responsive-table display" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                    <?php foreach ($products_by_price as $products) : ?>
                      <tr>
                        <td>
                          <?= $products['name'] ?>
                        </td>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2023 <a class="grey-text text-lighten-4" href="#" target="_blank">CYPHER</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Maseno students</a></span>
      </div>
    </div>
  </footer>
  <!-- END FOOTER -->

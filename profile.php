    ...
    <div class="card shadow p-3 mb-5 bg-body ">
        ...
        <div class="card-body">
            ...
            <form class="mb-3" action="router.php?page=profile_image_update" method="post" enctype="multipart/form-data">
                ...
                <input type="submit" name="Submit" value="Submit" class="btn mt-5 w-100 text-dark bg-primary">
            </form>
        </div>
    </div>
</div>
<div class="col-lg-9 col-md-9 col-sm-12 mt-3">
    <form class="g-3" style="height:20rem" action="" method="POST">
        <div class="row">
            <div class="col-lg-12">
                <h3>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            ...
            <div class="d-flex justify-content-center">
                <input type="submit" name="Submit" value="Submit" class="btn mt-5 w-50 text-dark bg-primary">
                </input>
            </div> 
            </div>
        </div>
